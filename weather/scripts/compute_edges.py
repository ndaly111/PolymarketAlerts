...
def main() -> int:
    ...
    if wrote > 0 and all_rows_for_md:
        ...
        md_lines = [
            ...
            "",
            f"Fee (open): {fee_cents}¢ (${fee_open:.2f}) | min EV: {min_ev:.2f} | min_q: {min_q:.2f} | support_tail_mass: {support_tail_mass} | support_overlap: {support_enabled} | min_vol: {min_volume} | min_oi: {min_open_interest} | max_spread_cents: {max_spread_cents} | top_n per city: {top_n}",
            "",
